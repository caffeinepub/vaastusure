...
import type { AnalysisRecord as _AnalysisRecord, AnalysisStatus as _AnalysisStatus, ExternalBlob as _ExternalBlob, RoomLabel as _RoomLabel, ScoreBreakdown as _ScoreBreakdown, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createAnalysis(arg0: string, arg1: ExternalBlob | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createAnalysis(arg0, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteAnalysis(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAnalysis(arg0: string): Promise<AnalysisRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.getAnalysis(arg0);
                return from_candid_AnalysisRecord_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getUserAnalyses(): Promise<Array<AnalysisRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAnalyses();
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAnalysis(arg0: string, arg1: AnalysisRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAnalysis(arg0, await to_candid_AnalysisRecord_n22(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AnalysisRecord_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AnalysisRecord): Promise<AnalysisRecord> {
    return await from_candid_record_n14(_uploadFile, _downloadFile, value);
}
function from_candid_AnalysisStatus_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AnalysisStatus): AnalysisStatus {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    roomLabels: Array<_RoomLabel>;
    scoreBreakdown: _ScoreBreakdown;
    floorPlanImage: [] | [_ExternalBlob];
    userId: Principal;
    structuralChanges: Array<string>;
    floorPlanName: string;
    issues: Array<string>;
    ...
    return {
        id: value.id,
        status: from_candid_AnalysisStatus_n15(_uploadFile, _downloadFile, value.status),
        roomLabels: value.roomLabels,
        scoreBreakdown: value.scoreBreakdown,
        floorPlanImage: record_opt_to_undefined(await from_candid_opt_n17(_uploadFile, _downloadFile, value.floorPlanImage)),
        userId: value.userId,
        structuralChanges: value.structuralChanges,
        floorPlanName: value.floorPlanName,
        issues: value.issues,
        easyFixes: value.easyFixes,
        vastuScore: value.vastuScore,
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? AnalysisStatus.pending : "complete" in value ? AnalysisStatus.complete : value;
}
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AnalysisRecord>): Promise<Array<AnalysisRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_AnalysisRecord_n13(_uploadFile, _downloadFile, x)));
}
async function to_candid_AnalysisRecord_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnalysisRecord): Promise<_AnalysisRecord> {
    return await to_candid_record_n23(_uploadFile, _downloadFile, value);
}
function to_candid_AnalysisStatus_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnalysisStatus): _AnalysisStatus {
...
async function to_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: to_candid_AnalysisStatus_n24(_uploadFile, _downloadFile, value.status),
        roomLabels: value.roomLabels,
        scoreBreakdown: value.scoreBreakdown,
        floorPlanImage: value.floorPlanImage ? candid_some(await to_candid_ExternalBlob_n11(_uploadFile, _downloadFile, value.floorPlanImage)) : candid_none(),
        userId: value.userId,
        structuralChanges: value.structuralChanges,
        floorPlanName: value.floorPlanName,
        issues: value.issues,
...
function to_candid_variant_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnalysisStatus): {
    pending: null;
} | {
    complete: null;
} {
